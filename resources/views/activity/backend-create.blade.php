<div class="modal fade" id="create-activity" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('activity.store') }}" id="lease-create" method="POST" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="title" class="form-control" placeholder="Titel activiteit">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="date" name="activiteit_datum" placeholder="Activiteit datum." class="form-control">
                        </div>

                        <div class="col-md-2">
                            <input type="text" name="start_hour" class="form-control" placeholder="start. bv. 00:00">
                        </div>

                        <div class="col-md-2">
                            <input type="text" name="end_hour" class="form-control" placeholder="eind. bv. 00:00">
                        </div>
                    </div>
